...
$MyDataBase = "mybd";
$MyTable = "product";// table name
// connected to database
$db = mysqli_connect($Domain, $User, $Password, $MyDataBase) or die('Connection to DB failed');
if(!$db) die(mysqli_connect_error());
mysqli_set_charset($db, "utf8");
// example of our table
$QueryC = "CREATE TABLE `".$MyTable."` (`id` INT AUTO_INCREMENT, `SKU` INT, `name` VARCHAR(20) NOT NULL, `price` INT, `size` TEXT, `HxWxL` TEXT, `weight` TEXT, PRIMARY KEY (id));";
// create the table
